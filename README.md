...
- Modify the `clusters.toml` file to fit your HPC. This means replacing the **<ADD_YOUR_HPC_NAME_STRING>** values with your custom values. For Example at GT, `phoenix`.
